  ...
  class ArticlesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @article.save
          format.html do
            redirect_to(administrate_article_params(@article), notice: "Article was successfully created.")
          end
    ...
    def update
      respond_to do |format|
        if @article.update(article_params)
          format.html do
            redirect_to(administrate_article_params(@article), notice: "Article was successfully updated.")
          end
